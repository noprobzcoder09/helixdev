...
@section('content')
		...
		<div class="left-container">
			<div class="top-content">
				<div class="col-md-7 col-sm-6 col-xs-6">
					<div class="row">
						<h4 class="breadcrumbs">OHS &gt; INSPECTIONS &gt; GOLDEN RULES</h4>
					</div>
				</div>
				<div class="col-md-3 pull-right">
					<div class="row btn-action">
						<button type="button" role="btn" class="btn btn-primary pull-right top-page-btn" href="javascript:void(0)" data-dialog="addRulesDialog"><span class="add-sign">+</span> ADD RULES</button>
					</div>
				</div>
			...
			<div class="col-md-12 body-content registers">
				<div class="row">
					<h5 class="fc-white">GOLDEN RULES / NON-NEGOTIABLES</h5>

					<table class="table content-white">
						<thead>
							<tr>
								<th colspan="3">CURRENT RULES</th>
							</tr>
						</thead>
						<tbody>
							@for ($i = 1; $i <= 5; $i++)
	...
	<!--	dialog box-->
	<div id="addRulesDialog" class="dialog">
