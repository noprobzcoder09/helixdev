		...
		<div class="left-container">
			<div class="top-content">
				<div class="col-md-7 col-sm-6 col-xs-6">
					<div class="row">
						<h4>OHS > INSPECTIONS > BUILD SUMMARY</h4>
					</div>
				</div>
				<div class="col-md-4 pull-right">
					<div class="row btn-action">
						<button type="button" role="btn" class="btn btn-primary btn-finalise-inspection btn-full pull-right"><i class="fa fa-check" aria-hidden="true"></i> FINALISE INSPECTION</button>
					</div>
				</div>
					...
					<table>
						<thead>
							<tr>
								...
								<td>CATEGORY</td>
								<td colspan="3" class="t-align-center">OPTION</td>
							</tr>
						</thead>
						<tbody>
							<tr class="border-bottom">
								...
								<td>Competency</td>
								<td class="yes t-align-center">YES</td>
								<td class="no t-align-center">NO</td>
								<td class="na t-align-center">NA</td>
							</tr>
						</tbody>
					</table>
