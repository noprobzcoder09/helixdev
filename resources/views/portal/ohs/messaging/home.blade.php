	...
	<div class="col-md-12 no-padding ohs">
		<div class="left-container">
			<div class="top-content">
				...
				<div class="col-md-3 pull-right">
					<div class="row btn-action">
						<button type="button" role="btn" class="btn btn-primary pull-right top-page-btn" href="javascript:void(0)" data-dialog="createDialog"><span class="add-sign"><img src="{{ url('img/message-icon.png') }}" style="width: 18px;"></span> SEE MESSAGING HISTORY</button>
					</div>
				</div>
			...
			<div class="col-md-12 body-content">
				<div class="row">
					<h5 class="fc-white">GROUP MESSAGING</h5>
